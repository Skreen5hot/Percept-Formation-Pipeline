...
// GREEN after S6 emits the witnessed co-type for every party + the orderer's bearer-of/realized-in role.
...
// --- the ORDERER bears a CustomerRole realized-in THIS act (canonical participation + role pattern) ---
...
ok(has(roleNode, 'obo:BFO_0000054', FRAME), 'CustomerRole obo:BFO_0000054 (realized-in) the act');

// --- the redline restriction: NO OTHER party asserts a realized-in role layer ---
...
console.log('S6 ROLE-LAYER PIN: GREEN (party co-typing + orderer CustomerRole realized-in act)');
